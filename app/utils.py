...
def resize_filter_image(image: PngImagePlugin.PngImageFile) -> Image.Image:
    """Resizes the image to the specified dimensions and sharpens it.
...
def invert_contrast_image(image: Image.Image) -> Image.Image:
    """Inverts the pixel values of the image and applies auto-contrasting to it
